...
/**
 * Coursework-specific navigation with custom SVG background
 * Desktop: Logo left, horizontal links right
 * Mobile: Logo centered, hamburger icon left
 */
export default function CourseworkNav() {
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 right-0 h-[450px] lg:h-[650px] overflow-hidden z-0">
        <Image
          src="/images/backgrounds/coursework-background.svg"
          alt=""
          fill
